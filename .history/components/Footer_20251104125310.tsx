          ...
          <div>
            <h3 className="text-xl font-semibold text-[#189677]">Socials</h3>
              <div className="flex items-center space-x-5 mt-4">
                <Link href="#" className="text-white hover:text-[#189677] text-2xl md:text-2xl"><FaFacebook /></Link>
                <Link href="#" className="text-white hover:text-[#189677] text-3xl"><FaTwitter /></Link>
                <Link href="#" className="text-white hover:text-[#189677] text-3xl"><FaInstagram /></Link>
            </div>
          </div>
        </div>
