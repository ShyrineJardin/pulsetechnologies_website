...
const WhyUs = () => {
  const reasons = [
    {
      icon: <FaDollarSign className="text-[#189677] text-5xl" />,
  ...
  return (
    <div id="why-us" className="container mt-20 px-6 text-center">
      <h2 className="text-5xl font-semibold mb-20">Why Choose <span className="text-[#189677]">Pulse Technologies?</span></h2>
