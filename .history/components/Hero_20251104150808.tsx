  ...
  return (
    <div className="relative overflow-hidden w-full h-screen flex items-center justify-center">
      ...
      <div data-aos="fade-up" className="relative z-10 text-center text-white px-6">
        ...
        <button className="mt-6 px-6 py-3 bg-[#189677] hover:bg-[#147a5f] text-white font-semibold rounded-lg transition duration-300 transform hover:scale-105"><a href="#contact">Contact Us</a>
        </button>
      </div>
