...
const Class = () => {
  const program = [
    ...
    },
    {
      ...
      title: "Mobility",
      description:
        "Moving something, or someone, from point A to point B with the most efficient way possible. Leveraging on
            location-based technologies, mobile devices, logistics, and crowdsourcing..",
