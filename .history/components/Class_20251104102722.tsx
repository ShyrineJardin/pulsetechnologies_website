...
const Class = () => {
  const program = [
    ...
    },
    {
      ...
      description:
        "We explore everything from delivery drones and 3d-printing to fan-speed controlling bots. We love to
            explore the intersection between hardware and software.",
