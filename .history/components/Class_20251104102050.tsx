...
const Class = () => {
  ...
  return (
    <div id="class" className="container mx-auto mt-20 text-center">
      ...
      <p className="mb-20 text-lg">Future-proof your business with cutting-edge IT solutions, ensuring seamlessscalability, security, and digital transformation</p>
