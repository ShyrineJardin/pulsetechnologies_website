        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-semibold text-[#189677]">Socials</h3>
              <div className="flex items-center space-x-7 mt-4 md:mt-0">
                <Link href="#" className="text-white hover:text-[#189677]"><FaFacebook /></Link>
                <Link href="#" className="text-white hover:text-[#189677]"><FaTwitter /></Link>
                <Link href="#" className="text-white hover:text-[#189677]"><FaInstagram /></Link>
            </div>
          </div>
        </div>
