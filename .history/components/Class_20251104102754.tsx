...
const Class = () => {
  const program = [
    ...
    },
    {
      ...
      description:
        "Solving the biggest problems top brands and retailers face today by changing consumer behaviour, extending
            market reach, and combining entertainment and profitability.",
