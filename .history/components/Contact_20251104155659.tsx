...
const Contact = () => {
    ...
    return (
        <>
            <div className="bg-gradient-to-b from-black to-gray-900 py-20" id="contact">
                <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="bg-gray-800 rounded-lg p-8 shadow-2xl">
                            ...
                            <form ref={form} className="space-y-6" onSubmit={handleSubmit} suppressHydrationWarning>
                                <div>
                                ...
                                <button 
                                    type="submit" 
                                    disabled={isSubmitting}
                                    className="w-full bg-[#189677] hover:bg-[#147a5f] text-white font-semibold py-3 px-6 rounded-lg transition duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                >
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-800 rounded-lg p-8 shadow-2xl">
                                ...
                                <div className="w-full h-64 rounded-lg overflow-hidden" suppressHydrationWarning>
                                    <iframe 
            ...
            {/* Closing Section with Video Background */}
