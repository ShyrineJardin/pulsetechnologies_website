    ...
    return (
        <div>
            <div className={`fixed ${navOpen} inset-0 transform transition-all duration-500 z-[1000] bg-black opacity-90 w-full h-screen`}>
                <div className={`text-white fixed ${navOpen} flex flex-col items-center justify-center h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-[#189677] space-y-5 z-[10000]`}>
